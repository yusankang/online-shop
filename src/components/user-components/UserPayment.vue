<template>
  ...
  <Form @submit="checkPayment" v-slot="{ errors }" v-if="payment === 'credit'">
    <div class="mb-3">
      ...
      <span v-if="creditNumError" class="text-danger" style="font-size: 14px"
        >信用卡卡號有誤！</span
      >
    </div>
    <div class="mb-3">
      ...
      <Field
        ...
        autocomplete="off"
        name="信用卡姓名"
        v-model="customerCardInfo.cardName"
        :class="{ 'is-invalid': errors['信用卡姓名'] }"
        rules="required"
      />
      <ErrorMessage name="信用卡姓名" class="invalid-feedback" />
    </div>
    <div class="row mb-3">
      <div class="col-9">
        ...
        <div class="row">
          <div class="col-6">
            <Field
              ...
              v-model="customerCardInfo.cardMonth"
              :class="{ 'is-invalid': errors['到期月份'] }"
              rules="required"
            >
            ...
            <ErrorMessage name="到期月份" class="invalid-feedback" />
          </div>
          <div class="col-6">
            <Field
              name="到期年份"
              ...
              id="cardYear"
              class="form-select"
              v-model="customerCardInfo.cardYear"
              :class="{ 'is-invalid': errors['到期年份'] }"
              rules="required"
            >
            ...
            <ErrorMessage name="到期年份" class="invalid-feedback" />
          </div>
        </div>
      </div>
      <div class="col-3">
        ...
        <Field
          ...
          rules="required"
        />
        <ErrorMessage name="CVV號碼" class="invalid-feedback" />
        <span v-if="cvvNumError" class="text-danger" style="font-size: 14px">CVV號碼有誤！</span>
      </div>
    </div>
    <div class="mb-3">
      <button type="submit" class="btn btn-warning w-100">確認付款</button>
    </div>
  </Form>

  <Form @submit="checkPayment" v-slot="{ errors }" v-if="payment === 'atm'">
    <div class="mb-3">
      <p>請匯款到以下帳號</p>
      <strong>您在匯款後，請告知我們匯款帳號末五碼</strong>
    </div>
    <table class="table">
      <tbody>
        <tr>
    ...
    <div class="mb-3">
      ...
      <Field
        ...
        rules="required"
      />
      <ErrorMessage name="帳號末五碼" class="invalid-feedback" />
