    ...
    <table class="w-100 mb-3">
      <tbody>
        ...
        <tr v-if="cart.final_total !== cart.total">
          ...
          <td class="text-success text-end">${{ $filters.currency(cart.final_total) }} NTD</td>
        </tr>
      ...
      <tfoot class="table-group-divider">
        <tr>
          <th>總計</th>
          <td v-if="cart.final_total !== cart.total && cart.final_total >= 2000" class="text-end">
          ...
          <td colspan="2">
            <div class="input-group my-3">
              ...
              <button
                ...
                type="button"
                id="coupon-button"
                @click="addCouponCode(couponCodeInput)"
              >
                套用優惠碼
              </button>
            </div>
