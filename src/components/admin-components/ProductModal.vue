        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-sm-4">
              ...
              <div class="d-flex flex-wrap" v-if="secondaryImages">
                <div v-for="(item, key) in tempProduct.imagesUrl" :key="key">
                  <img
                    class="me-2 mb-3 img-thumbnail"
                    style="max-height: 120px; max-width: 120px; object-fit: cover"
                    :src="item"
                    :alt="tempProduct.title"
                  />
...
export default {
  ...
  methods: {
    uploadFile(type) {
      this.fileType = type;
      const uploadedFile = type === 'main'
        ? this.$refs.mainImageFileInput.files[0]
        : this.$refs.secondaryImagesFileInput.files[0];
