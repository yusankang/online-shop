        ...
        <tr>
          ...
          <td>
            <div class="form-check">
              <label class="form-check-label" for="`paidCheck${item.id}`">
                <input
                  type="checkbox"
...
import OrderModal from '../../components/admin-components/OrderModal.vue';
import DeleteModal from '../../components/admin-components/DeleteModal.vue';
import Pagination from '../../components/admin-components/PaginationComponent.vue';
