<template>
  ...
  <div class="pt-5">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <router-link to="/user/products"
              class="text-warning border-bottom border-warning">
              商品列表
            </router-link>
          </li>
        ...
        <div class="col-md-5">
          <div class="card">
            <div class="card-body">
              ...
              <del class="h6 card-text" v-if="product.price !== product.origin_price">
              ...
              <div class="mb-3">
                ...
                <span v-if="message" class="text-danger"> {{ message }}{{ product.unit }} </span>
              </div>
              <div class="d-grid">
                <button
                  type="button"
                ...
                >
                  <div
                    class="spinner-grow spinner-grow-sm text-dander"
                    role="status"
    ...
    <section>
      ...
      <SwiperSlider :category="'other'" @productId="checkProduct" />
...
import ProductCarousel from '../../components/user-components/CarouselComponent.vue';
